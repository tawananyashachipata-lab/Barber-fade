//#region node_modules/.nitro/vite/services/ssr/assets/shop-DPoJgazS.js
var SHOP = {
	name: "Mercer Barbers",
	...
	mapsUrl: "https://www.google.com/maps/search/?api=1&query=24+Ironmonger+Row+Clerkenwell+London+EC1V+3RP",
	socials: [
		{
			label: "Instagram",
...
function upcomingDates(count = 12) {
	const out = [];
...
//#endregion
export { formatDateLong as a, upcomingDates as c, TIME_SLOTS as i, SERVICES as n, formatDateTile as o, SHOP as r, toDateKey as s, BARBERS as t };
