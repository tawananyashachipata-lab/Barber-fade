import { a as formatDateLong, c as upcomingDates, i as TIME_SLOTS, n as SERVICES, o as formatDateTile, r as SHOP, s as toDateKey, t as BARBERS } from "./shop-DPoJgazS.js";
import { useMemo, useState } from "react";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
//#region src/lib/calendar.ts
function pad(n) {
...
//#endregion
//#region src/components/BookingWidget.tsx
var STEPS = [
	"Service",
	"Barber",
	"Date & time",
...
function BookingWidget() {
	...
	if (confirmed && event && service && barber && date && time) return /* @__PURE__ */ jsxs("div", {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			step === 1 && /* @__PURE__ */ jsx("div", {
				className: "grid sm:grid-cols-3 gap-3",
				children: BARBERS.map((b) => /* @__PURE__ */ jsxs("button", {
					type: "button",
					onClick: () => setBarber(b),
			...
			step === 2 && /* @__PURE__ */ jsxs("div", { children: [
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: dates.map((d) => /* @__PURE__ */ jsx("button", {
						type: "button",
						onClick: () => setDate(d),
			...
			step < 3 && /* @__PURE__ */ jsxs(Fragment, { children: [error && /* @__PURE__ */ jsx("p", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
									...
									children: SHOP.hours.map((h) => /* @__PURE__ */ jsxs("li", {
										className: "flex justify-between gap-4",
										children: [/* @__PURE__ */ jsx("span", { children: h.days }), /* @__PURE__ */ jsx("span", { children: h.time })]
									}, h.days))
								})] })
							]
						})
